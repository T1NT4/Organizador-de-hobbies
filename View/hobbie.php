<div class="container hobbie">
        ...
        <form method="POST" id="proficiencia_<?=$id_hobbie?>">
        ...
        <div class="container vertical"><h4>metas do hobby</h4><div class="add"><input type="checkbox" class="criar_meta"><i class="fa-solid fa-plus"></i></div></div>
        <div class="metas-container container">
            <form method="POST" class="container meta">
                ...
                <textarea name="descricao" placeholder="descrição da meta, como você ira fazer, instruções, planos, etc..."></textarea>
